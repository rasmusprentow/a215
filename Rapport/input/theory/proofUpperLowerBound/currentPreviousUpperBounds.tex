...
He modified Thistlethwaite's algorithm and founds some shortcuts to reduce the moves by replacing the \mv{G3} subgroup with a different subgroup and removed a move between stage 3 and 4.
