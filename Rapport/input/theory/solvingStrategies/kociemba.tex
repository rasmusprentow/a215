...
The first time this \textbf{if}-statement is executed it will return true and this will be the new length of the solution. The \textbf{while} loop will end when $d$ is incremented to $l$.
\begin{figure}[htb]
	\centering
...
In figure \ref{fig:searchExpansion} the amount of elements in $S^d$ to a specific $d$ is attempted to be shown.
\begin{figure}[!hb]
	\centering
