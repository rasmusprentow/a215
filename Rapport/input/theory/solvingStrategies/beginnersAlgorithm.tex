...
\begin{figure}[htb]
	\centering
		\subfloat[\myCaption{The up face colors form the opposite L}]{\label{fig:cross:4LLcross1}\includegraphics[width=0.28\textwidth]{input/pics/4LLcross1.jpg}}
		\hspace{0.02\textwidth}
		\subfloat[\myCaption{The up face colors form the horizontal line}]{\label{fig:cross:5LLcross2}\includegraphics[width=0.28\textwidth]{input/pics/5LLcross2.jpg}}
		\hspace{0.02\textwidth}
		\subfloat[\myCaption{The up face colors form the cross}]{\label{fig:cross:6LLcross3}\includegraphics[width=0.28\textwidth]{input/pics/6LLcross3.jpg}}
		\caption{\myCaption{The steps in the completion of the last layer cross}}
		\label{fig:cross}
\end{figure}
%Tjek om billederne står rigtigt
