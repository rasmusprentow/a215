...
\begin{figure}[htb]
	\centering
		\subfloat[\myCaption{A relabeled cube that has been permutated with the move D.}]{\label{fig:cross:4LLcross1}\includegraphics[width=0.28\textwidth]{input/pics/4LLcross1.jpg}}
		\hspace{0.02\textwidth}
		\subfloat[\myCaption{A relabeled cube that has been permutated with the move D.}]{\label{fig:cross:5LLcross2}\includegraphics[width=0.28\textwidth]{input/pics/5LLcross2.jpg}}
		\hspace{0.02\textwidth}
		\subfloat[\myCaption{A relabeled cube that has been permutated with the move D.}]{\label{fig:cross:6LLcross3}\includegraphics[width=0.28\textwidth]{input/pics/6LLcross3.jpg}}
		\caption{\myCaption{123321}}
		\label{fig:cross}
\end{figure}
