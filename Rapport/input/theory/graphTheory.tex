...
\begin{figure}[htb]
	\centering
		\subfloat[\myCaption{A simple connected graph.}]{\label{fig:simpleConnectedGraph}\includegraphics[width=0.15\textwidth]{input/pics/simpleConnectedGraph.png}}
		\hspace{0.02\textwidth}
		\subfloat[\myCaption{A simple unconnected graph.}]{\label{fig:simpleUnconnectedGraph}\includegraphics[width=0.15\textwidth]{input/pics/simpleUnconnectedGraph.png}}
		\hspace{0.02\textwidth}
		\subfloat[\myCaption{The up face colors form the cross}]{\label{fig:simpleDirectionalGraph}\includegraphics[width=0.15\textwidth]{input/pics/simpleDirectionalGraph.png}}
