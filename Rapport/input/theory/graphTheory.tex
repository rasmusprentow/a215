...
For a graph of the \rubik{} it would be ideal to make vertices represent positions and edge represent \twist{}s. The weight of the edges would then be the number of \twist{}s required to get from one of the vertex to the other -- hence the weight for every edge would be 1 if only edges representing a single \twist{} is included in the graph.
