...
\myTop{This chapter will present some different algorithms which can be used for solving a Rubik's Cube. Two of these algorithms will be used as a foundation for the implementation part, which makes this chapter essential for the report. 
