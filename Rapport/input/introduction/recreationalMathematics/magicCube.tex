...
Both of them have a magic constant, which can be the sum of each row, colon and pillar.
...
The first is that the \mcube{} consists of numbers whereas the \rubik{} have colors, which are different on each \face{}.
