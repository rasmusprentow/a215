...
\label{sec:kSolve}
The method named \vr{solve} (see \ref{src:kociemba}) acts like a main routine for the solving mechanism. By calling this method kociembasalgortihm will be applied onto the \rubik{}. 
...
%evt sætte de 5 variabler i punktform??
