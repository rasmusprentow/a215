...
\end{itemize}
\myTail{This chapter has presented the choices which we made before we started our actual implementation and which approach we took to test Kociemba's optimal solver and the beginner's algorithm.}
