...
If the \cpiece is oriented incorrectly in the correct \cubicle{} the program will use \vr{algorithm 5}  to move the edge \cpiece{} to the top layer and move it back to the same position -- but now the orientation will be correct. 
