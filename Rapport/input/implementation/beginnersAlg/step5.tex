...
If the the two correctly positioned edges are positioned directly across each other \vr{algorithm 4bA} is performed, this will result in two correctly positioned edge \cubie{}s next to each other.

The program checks which two edge \cpiece{}s are positioned correctly and performs \vr{algorithm 4bA} accordingly. 
