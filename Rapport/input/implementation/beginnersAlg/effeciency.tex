...
\begin{figure}[htbp]
	\centering
		\includegraphics{input/pics/beginnersSolve.pdf}
	\caption{\myCaption{The graph shows the amount of moves needed to solve a cube with 50 scrambles. x is the amount of test. The lines are for showing only and do not represent the average between the dots.}}
