...
The size of a lookup table containing every move sequences to solve the \rubik{} inside $H$ would be: $987$ GB \ref{chap:maple}, which exceeds the average memory on todays computer \cite{averageRAM} \cite{maxRAM2}.
