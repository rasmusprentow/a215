...
When a move has been incremented the \rubik{} will be permuted with this new move sequence and the test will run again and a new move will be incremented untill the \rubik{} is in \m{H}.
