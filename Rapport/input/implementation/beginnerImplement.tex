...
\myTop{In this chapter the process of implementing the beginner's algorithm, which is described in section \ref{sec:beginner}, will be presented.
This implementation will not be as effective as the beginner's algorithm is capable of since it is a proof of concept.
How efficient it is will be presented in form of statistics about the number of twists it need to solve the Rubik's Cube.}
...
\myTail{In this chapter the implementation of the beginners algorithm is described.
Statics about out implementation is gathered in order to compare this algorithm to Kociemba's optimal solver.}