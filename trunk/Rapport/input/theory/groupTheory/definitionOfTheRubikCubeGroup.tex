...
\begin {itemize}
\item When two elements are combined with an operation then the new element these create must also be a part of the group. For instance a move \m{M$_1$} and a move $M_2$ then $M_1 * M_2$ will form a new move or move sequence which also is a part of the group.
...
%Mangler en afrunding og mske lidt udskrivning af den sidste linje om at * er associativ.
