...
\item \myTermHigh{\cpiece{c}} The \rubik{} consists of 26 \cpiece{}s.
\item \myTermHigh{\cubicle{c}} A static frame that the \cpiece{} can be placed in.
\item \myTermHigh{Corner}Corner \cpiece{}s have 3 \facet{}s and are placed at the corners. The \rubik{} has 8 corners. 
\item \myTermHigh{Edge}Edge \cpiece{}s have 2 \facet{}s and are placed at the edges of each face. The \rubik{} has 12 edges.
\item \myTermHigh{Center}Center \cpiece{} have 1 \facet{} and are placed at the center of each face and are immovable unless the cube is turned. 
...
\item \myTermHigh{Half-turn metric}In this metric of notation half-turn(M2) is allowed. 
\item \myTermHigh{Quarter-turn metric}In this metric half-turn is not allowed.
\end{itemize}
...
A 180 degree \twist{} of a face is denoted \m{M2}. 
Beside the normal face \twist{} there are middle \twist{}s. These are denoted \m{Mm Mm' Mm2} e.g. \m{Rm2} is a \twist{} of the middle section looking from the \m{R} face. This \twist{} is equal to the two \twist{} \m{R2 L2}.  
...
\end{itemize}
\myTail{This chapter gives the reader the basic terms used in this report.}
