...
\begin{figure}[htbp]
	\centering
		\includegraphics[scale = 0.7]{input/pics/superflip.pdf}
	\caption{\myCaption{The superflip: every edge is flipped. The lenght of the optimal solution to this position is 20 twists. A sequence to this position is: \m{F B U2 R F2 R2 B2 U' D F U2 R' L' U B2 D R2 U B2 U}}}
	\label{fig:superflip}
\end{figure}
