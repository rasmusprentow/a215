...
\begin{figure}[htb]
	\centering
	\subfloat[\myCaption{A relabeled cube that has been permutated with the move D'.}]{\label{fig:relabel2:D'}\includegraphics[width=0.45\textwidth]{input/pics/relabel3.PNG}}
	\vspace{0.1\textwidth}
	\subfloat[\myCaption{A relabeled cube that has been permutated with the move F2.}]{\label{fig:relabel2:F2}\includegraphics[width=0.45\textwidth]{input/pics/relabel2.PNG}}
