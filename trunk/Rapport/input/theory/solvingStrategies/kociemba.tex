...
\begin{figure}[!hbt]
	\centering
	\subfloat[\myCaption{A relabeled cube that has been permutated with the move \m{D}.}]{\label{fig:relabel2:D}\includegraphics[width=0.45\textwidth]{input/pics/relabelD.PNG}}
	\hspace{0.05\textwidth}
	\subfloat[\myCaption{A relabeled cube that has been permutated with the move \m{R2}.}]{\label{fig:relabel2:R2}\includegraphics[width=0.45\textwidth]{input/pics/relabelR2.PNG}}
