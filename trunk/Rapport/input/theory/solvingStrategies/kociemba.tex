...
\label{sec:kociemba}
Kociemba's optimal solver is an algorithm created with the purpose to find the twist-wise optimal solution to any scrambled \rubik{}\cite{kociemba09} \cite{cubelovers92}. The algorithm consists of two phases. The first phase is based on a principle called relabeling, which will be defined at first. 
