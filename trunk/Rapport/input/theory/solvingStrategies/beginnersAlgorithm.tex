...
\begin{center}
	\includegraphics[width=0.35\textwidth]{input/pics/1FLCross}	
\end{center}
...
\begin{wrapfigure}{R}{0.4\textwidth}
\begin{center}
	\includegraphics[width=0.35\textwidth]{input/pics/2FL}	
\end{center}
...
\begin{center}
	\includegraphics[width=0.35\textwidth]{input/pics/3F2L}	
\end{center}
...
\begin{figure}[htb]
	\centering
		\subfloat[\myCaption{The up face colors form the opposite L.}]{\label{fig:cross:4LLcross1}\includegraphics[width=0.28\textwidth]{input/pics/4LLcross1}}
		\hspace{0.02\textwidth}
		\subfloat[\myCaption{The up face colors form the horizontal line.}]{\label{fig:cross:5LLcross2}\includegraphics[width=0.28\textwidth]{input/pics/5LLcross2}}
		\hspace{0.02\textwidth}
		\subfloat[\myCaption{The up face colors form the cross.}]{\label{fig:cross:6LLcross3}\includegraphics[width=0.28\textwidth]{input/pics/6LLcross3}}
...
\begin{wrapfigure}{R}{0.4\textwidth}
\begin{center}
	\includegraphics[width=0.35\textwidth]{input/pics/7LLedges}	
\end{center}
...
\begin{wrapfigure}{R}{0.4\textwidth}
\begin{center}
	\includegraphics[width=0.35\textwidth]{input/pics/8done}	
\end{center}
