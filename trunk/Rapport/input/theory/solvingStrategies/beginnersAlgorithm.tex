...
\begin{figure}[htb]
	\centering
		\subfloat[\myCaption{A relabeled cube that has been permutated with the move D.}]{\label{fig:2345365887}\includegraphics[width=0.28\textwidth]{input/pics/4LLcross1.jpg}}
		\hspace{0.05\textwidth}
		\subfloat[\myCaption{A relabeled cube that has been permutated with the move D.}]{\label{fig:542523}\includegraphics[width=0.28\textwidth]{input/pics/5LLcross2.jpg}}
		\hspace{0.05\textwidth}
		\subfloat[\myCaption{A relabeled cube that has been permutated with the move D.}]{\label{fig:23454325}\includegraphics[width=0.28\textwidth]{input/pics/6LLcross3.jpg}}
		\caption{123321}
		\label{fig:something}
\end{figure}
