...
\myTop{The upper bound of the \rubik{} will be presented and explained in this chapter. The upper bound needs to be proven, in order for it to be recognized. That is why, how the current upper bound came to be is explained.}
