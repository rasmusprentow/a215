...
This is easy for small graph such as the \nameref{sub:middleMoveGraph} \ref{sub:middleMoveGraph}, which will be described later in this chapter. For bigger graph such as the full \rubik{} graph this is practically impossible. 
