...
\myTop{This chapter regards the graph theory in relation to the Rubik's Cube. There will be a description of the shortest path and calculation of the diameter of a graph, which could be a way to prove the upper bound. The chapter will  conclude with an example using a much smaller Rubik's Cube graph; the Middle movement graph.}
