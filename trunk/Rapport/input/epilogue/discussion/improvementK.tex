...
If this is combined with the previous improvement it could make the search time to get into \m{H} shorter.
...
The last way we will mention is when searching in general the moves in \m{S} and \m{A} could be divided into groups and a new thread could be made for these new groups of moves.