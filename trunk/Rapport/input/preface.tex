...
The course of the project commenced on \myDate{1}{2}{2010}, and the paper was handed in on \myDate{27}{5}{2010}.
...
Group theory related names, such as moves, are written in \m{bold} and variable and function names are written in \vr{italic}.
