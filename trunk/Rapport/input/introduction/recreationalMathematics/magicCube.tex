...
Looking at the \rubik{} it is easy to see that it looks a lot like the \mcube{}. The major difference is that the \mcube{} has a number in the center where the \rubik{} do not because it is rotating around that piece. Another big difference is that the \mcube{} consist of numbers whereas the \rubik{} have colors, which are diffent on each \face{}s.
