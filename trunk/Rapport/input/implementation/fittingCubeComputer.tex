\chapter{Digitalizing the Rubik's Cube}
...
\myTail{In this chapter the process of digitalizing the Rubik's Cube has been described. This implementation gives a foundation for implementing the solving algorithms. }