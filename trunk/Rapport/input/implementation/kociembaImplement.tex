...
We are interested in the shortest move sequence to solve a scrambled cube, where as the original Kociemba optimal solver only tries to find the shortest length, not the actual sequence of moves.
