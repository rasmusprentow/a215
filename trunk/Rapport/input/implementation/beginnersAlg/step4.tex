...
\end{enumerate}
It is \vr{algorithm 4aA} that needs to be performed no matter what the case is. In case one the algorithm is applied twice, case two the algorithm is applied three times, case three the algorithm is applied once.