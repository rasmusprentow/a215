...
\myTop{In this chapter the process of implementing the beginner's algorithm, which is described in section \ref{sec:beginner}, will be presented. This implementation will not be as effective as the beginner's algorithm is capable of since it is a proof of concept.}
