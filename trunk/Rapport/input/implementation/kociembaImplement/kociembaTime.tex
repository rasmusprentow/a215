...
\begin{figure}[htb]
	...
	\caption{\myCaption{The approximation of the time needed to finish the search depth in \m{S}. It is displayed on a logarithmic y-axis to show that an exponential function seem to fit.}}
...
During our test our solver entered \m{H} many times.
