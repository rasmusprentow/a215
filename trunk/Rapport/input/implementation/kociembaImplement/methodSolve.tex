...
\label{sec:kSolve}
The method named \vr{solve} (see code snippet \ref{src:kociemba}) connects all the submethods into one big method that apply Kociemba's algorithm onto the \rubik{}. 
