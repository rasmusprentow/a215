...
\usepackage{natbib}
\usepackage{dk-bib}
\usepackage[a4paper, bookmarks=true, bookmarksopen=true, bookmarksnumbered=true, colorlinks=true, breaklinks=true, backref=section, pdfborder={0 0 0 0}]{hyperref}
