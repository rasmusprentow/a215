...
\newcommand{\startTail}{ \Huge Change this command til myTop with the top as argument}%
\newcommand{\stopTail}{ \Huge Change this command til myTop with the top as argument}%
