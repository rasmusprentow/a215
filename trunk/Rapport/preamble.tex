...
%tops 'n' tails
\newcommand{\myTop}[1]{\textit{#1} \\}%
\newcommand{\myTail}[1]{  \ \\ \textit{#1}}%
\newcommand{\startTop}{\Huge{Change this command til myTop with the top as argument} \\}%
\newcommand{\stopTop}{ \Huge{Change this command til myTop with the top as argument} \\}%
\newcommand{\startTail}{ \Huge{Change this command til myTail with the tail as argument} \\}%
\newcommand{\stopTail}{ \Huge{Change this command til myTail with the tail as argument} \\ }%
