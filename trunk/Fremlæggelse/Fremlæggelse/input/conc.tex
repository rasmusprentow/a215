...
\begin{figure}
	...
	%\caption{Udvikling af grænserne}
	\label{fig:bounds3}
\end{figure}
\end{frame}
...
\begin{itemize}
	...
	\begin{itemize}
		\item Twist-wise
		\begin{itemize}
			\item Vores begynderalgoritme bruger i snit 151 tr\ae{}k
			\item Vores Kociemba bruger højest 22 tr\ae{}k
		\end{itemize}
		\item Time-wise
		\begin{itemize}
			\item Vores begynderalgoritme bruger under 1 ms
			\item Vores Kociemba bruger op til 18 mio. \aa{}r
		\end{itemize}
		\item Computertests
		\begin{itemize}
			\item Computerimplementering af l\o{}sningsalgoritmer
		\end{itemize}
	\end{itemize}
\end{itemize}
\end{frame}